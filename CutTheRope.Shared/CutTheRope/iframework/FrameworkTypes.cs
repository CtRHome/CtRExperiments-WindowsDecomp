...
internal partial class FrameworkTypes : MathHelper
{
	public class FlurryAPI
	{
		public static bool enabled = true;

		public static void logEvent(string s, List<string> Parameters_Double_String)
		{
			if (!enabled)
			{
				return;
			...
			if (Parameters_Double_String != null)
			{
				...
				{
					Parameter item = new Parameter(Parameters_Double_String[i * 2], Parameters_Double_String[1 + i * 2]);
					list.Add(item);
				}
				Api.LogEvent(s, list);
			}
