...
internal class BaseElement : NSObject
{
	...
	public static void restoreColor(BaseElement t)
	{
	...
	public virtual void postDraw()
	{
		...
		{
			if (childs.TryGetValue(num2, out var value))
			{
	...
	public virtual int addTimeline(Timeline t)
	{
		...
		{
			for (i = 0; i <= timelines.Keys.Last() && timelines.ContainsKey(i); i++)
			{
			}
		}
		int num = i;
		addTimelinewithID(t, num);
		return num;
	}
