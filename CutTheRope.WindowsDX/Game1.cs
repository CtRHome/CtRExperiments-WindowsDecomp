...
namespace CutTheRope
{
	public class Game1 : Game
	{
		...
		protected override void LoadContent()
		{
			...
			if (form != null)
			{
				form.MaximizeBox = false; // fullscreen is disabled
			}
		...
		protected override void Update(GameTime gameTime)
		{
			...
			/*
			if ((IsKeyPressed(Microsoft.Xna.Framework.Input.Keys.F11) || ((IsKeyDown(Microsoft.Xna.Framework.Input.Keys.LeftAlt) || IsKeyDown(Microsoft.Xna.Framework.Input.Keys.RightAlt)))))
			{
				Global.ScreenSizeManager.ToggleFullScreen();
				Thread.Sleep(500);
				return;
			...
			*/
			...
			MovieMgr movieMgr = iframework.core.Application.sharedMovieMgr();
			movieMgr.start();
			if (movieMgr.isPlaying())
			{
				movieMgr.update();
                Global.MouseCursor.Enable(movieMgr.isPaused());
            }
			CtrRenderer.update((float)gameTime.ElapsedGameTime.Milliseconds / 1000f, Global.MouseCursor.GetTouchLocation());
		...
		protected override void Draw(GameTime gameTime)
		{
			...
			if (iframework.core.Application.sharedMovieMgr().isPlaying())
			{
                DrawMovie();
            }
